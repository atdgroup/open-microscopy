# Name: Region Move and save AF
# Description: Move stage, get image(s) and save, with autofocus at start of each region
# Author: Default
# Category: Regions
...
def OnNewPoint(x, y, z, position):
    ...
    print "Auto focused position ", autoFocusedZPosition
