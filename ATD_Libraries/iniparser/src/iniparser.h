...
/**
  ...
  is the format name1=value1\0name2=value2\0\0
...
// Added by Glenn pierce. Reads an ini section into an existing dictionary
dictionary* iniparser_load_section_into_dictionary(dictionary* d, const char * ininame, const char *section);

// Added by Glenn pierce. Saves a dictionary to a ini file format
void iniparser_save(dictionary * d, FILE * out);

// Added by Paul Barber. Saves a dictionary to an ini file, with quotes around values
