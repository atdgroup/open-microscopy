...
Simple execute test/test.py

It will load the freeimage.jpg and make some test on it.
You can see its output into the images created, and into the message
on you screen. The same massges are saved on the output.txt file
