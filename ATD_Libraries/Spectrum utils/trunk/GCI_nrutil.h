...
#define nrerror(error_text) \
  { MessagePopup("Numerical Recipes Run-Time Error", (error_text)); \
    GCI_error=1; return NULL; }

#define nrerror1(error_text) \
  { MessagePopup("Numerical Recipes Run-Time Error", (error_text)); \
    GCI_error=1; return -1; }

#define nrerrorv(error_text) \
  { MessagePopup("Numerical Recipes Run-Time Error", (error_text)); \
    GCI_error=1; return; }
