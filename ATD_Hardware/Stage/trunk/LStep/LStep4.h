#include <cvidef.h>
    ...
    extern "C" {
		...
		int __stdcall LS_GetPitch (double* dX, double* dY, double* dZ, double* dA);  
		...
		int __stdcall LS_GetVel (double* dX, double* dY, double* dZ, double* dA);
        int __stdcall LS_SetAccel (double dX, double dY, double dZ, double dA);
		int __stdcall LS_GetAccel (double* dX, double* dY, double* dZ, double* dA);  
		...
		int __stdcall LS_SetBPZJoyspeed (int apar, double value); 
		int __stdcall LS_SetDigJoySpeed (double dX, double dY, double dZ, double dA);   
		int __stdcall LS_GetDigJoySpeed (double* dX, double* dY, double* dZ, double* dA);   
		...
		int __stdcall LS_WaitForAxisStop (int iaflags, int iatimeout, int pbatimeout); 
